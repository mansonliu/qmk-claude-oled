...
| waiting 提示 | OLED「INPUT」滿屏閃爍 + RGB 黃燈同相位閃爍(0.6s/0.3s)，無聲 |
| 震動馬達/蜂鳴器 | 本片沒焊馬達(HAPTIC 移除)；蜂鳴器版試過太大聲，使用者要求取消(audio 停用) |
| flash 已砍清單 | RGB動畫引擎(working呼吸手寫)、grave_esc/space_cadet/magic/tap_dance/combo/key_override/qmk_settings |
